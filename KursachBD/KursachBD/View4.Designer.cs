namespace KursachBD
{
    partial class View4
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Value = this.StanciiBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "KursachBD.Report4.rdlc";
            ...
            this.Name = "View4";
            this.Text = "View4";
            this.Load += new System.EventHandler(this.View4_Load);
        ...
        private BDDataSetTableAdapters.StanciiTableAdapter StanciiTableAdapter;
    }
}